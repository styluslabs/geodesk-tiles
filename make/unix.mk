...
distclean:
	rm -rf $(BUILDDIR)/../Debug $(BUILDDIR)/../Release
...
compile_commands:
	make CXX=clang++ CC=clang --always-make --dry-run | grep "^clang" | jq -nR '[inputs | {directory: "$(COMPILE_CMDS_DIR)", command: ., file: (split(" ") | last)}]' > compile_commands.json
